...
/* border-right: 1px dotted #066; */
 ...
 <body id="Dada">
  <div id="PageWrapper">
   ...
   <div id="Header">
    <span id="Logo">
     <a href="mail.cgi">TELIC Arts Exchange</a>
    </span>
    <span id="Title">
     Sign Up for a List
    </span>
...
<!-- end list_popup_subscription_form.tmpl -->
    ...
    <h1>
     Available Lists:
        ...
        <h2>
         <a href="mail.cgi/list/announcements/index.html">
          TELIC
         </a>
        </h2>
        <p>
...
TELIC Arts Exchange is a 501(c)3 non-profit organization.  </p>
        <p></p>
                ...
                <blockquote>
                 <p>
                  <strong>
                   <a href="mail.cgi/archive/announcements/newest/index.html">
...
.everything h3.title a {font-weight: bold; font-size: 12px; color: ...
	...
	<p style="text-align:center">
	 <strong>
	  <a href="mail.cgi/admin/index.html">
	   Administration
	  </a>
	 </strong>
	</p>
...
<!-- end default_screen.tmpl -->
                                                                                                                                                                                                        <a href="mail.cgi/art/index.html" style="font-size:1px;color:#FFFFFF">i &lt;3 u </a>
   </div><!-- ends id="Content" -->
